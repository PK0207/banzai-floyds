...
unused_lines = [{'wavelength': 3451.689, 'line_strength': '', 'line_source': 'Hg', 'line_notes': 'No flux in FLOYDS'},
                ...
                {'wavelength': 4680.1359, 'line_strength': '', 'line_source': 'Zn',
                 'line_notes': 'Removed until we start turning on the Zn lamp again.'},
                {'wavelength': 4722.1569, 'line_strength': '', 'line_source': 'Zn',
                 'line_notes': 'Removed until we start turning on the Zn lamp again.'},
                {'wavelength': 4810.5321, 'line_strength': '', 'line_source': 'Zn',
                 'line_notes': 'Removed until we start turning on the Zn lamp again.'},
                {'wavelength': 5181.9819, 'line_strength': '', 'line_source': 'Zn',
                 'line_notes': 'Removed until we start turning on the Zn lamp again.'},
                ...
                {'wavelength': 8014.7857, 'line_strength': 0.2952, 'line_source': 'ArI',
                 'line_notes': 'Blended in FLOYDS'},
                {'wavelength': 8103.6931, 'line_strength': '', 'line_source': 'ArI',
                 'line_notes': 'Blended in FLOYDS'},
                {'wavelength': 8115.3108, 'line_strength': 0.5181, 'line_source': 'ArI',
                 'line_notes': 'Blended in FLOYDS'},
                {'wavelength': 8408.2096, 'line_strength': '', 'line_source': 'ArI',
                 'line_notes': 'Blended in FLOYDS'},
                ...
                {'wavelength': 10673.55, 'line_strength': '', 'line_source': 'ArI',
