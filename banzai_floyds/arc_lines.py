...
unused_lines = [{'wavelength': 3451.689, 'line_strength': '', 'line_source': 'Hg', 'line_notes': 'No flux in FLOYDS'},
                ...
                {'wavelength': 5675.81, 'line_strength': '', 'line_source': 'Hg', 'line_notes': 'Weak'},
                {'wavelength': 4680.1359, 'line_strength': '', 'line_source': 'Zn', 'line_notes': 'Removed until we start turning on the Zn lamp again.'},
                {'wavelength': 4722.1569, 'line_strength': '', 'line_source': 'Zn', 'line_notes': 'Removed until we start turning on the Zn lamp again.'},
                {'wavelength': 4810.5321, 'line_strength': '', 'line_source': 'Zn', 'line_notes': 'Removed until we start turning on the Zn lamp again.'},
                {'wavelength': 5181.9819, 'line_strength': '', 'line_source': 'Zn', 'line_notes': 'Removed until we start turning on the Zn lamp again.'},
                {'wavelength': 6114.9232, 'line_strength': '', 'line_source': 'ArII', 'line_notes': ''},
                {'wavelength': 6766.6117, 'line_strength': '', 'line_source': 'ArI', 'line_notes': ''},
                {'wavelength': 6827.2529, 'line_strength': '', 'line_source': 'ArI', 'line_notes': ''},
                {'wavelength': 6937.6642, 'line_strength': '', 'line_source': 'ArI', 'line_notes': ''},
                {'wavelength': 7206.9804, 'line_strength': '', 'line_source': 'ArI', 'line_notes': ''},
                {'wavelength': 7372.1184, 'line_strength': '', 'line_source': 'ArI', 'line_notes': 'Blended in FLOYDS'},
                {'wavelength': 7383.9805, 'line_strength': 0.1489, 'line_source': 'ArI', 'line_notes': 'Blended in FLOYDS'},
                {'wavelength': 7503.8691, 'line_strength': 0.253, 'line_source': 'ArI', 'line_notes': 'Blended in FLOYDS'},
                {'wavelength': 7514.6518, 'line_strength': '', 'line_source': 'ArI', 'line_notes': 'Blended in FLOYDS'},
                {'wavelength': 7723.7599, 'line_strength': 0.3542, 'line_source': 'ArI', 'line_notes': 'Blend'},
                {'wavelength': 8006.1567, 'line_strength': '', 'line_source': 'ArI', 'line_notes': 'Blended in FLOYDS'},
                {'wavelength': 8014.7857, 'line_strength': 0.2952, 'line_source': 'ArI', 'line_notes': 'Blended in FLOYDS'},
                {'wavelength': 8103.6931, 'line_strength': '', 'line_source': 'ArI', 'line_notes': 'Blended in FLOYDS'},
                {'wavelength': 8115.3108, 'line_strength': 0.5181, 'line_source': 'ArI', 'line_notes': 'Blended in FLOYDS'},
                {'wavelength': 8408.2096, 'line_strength': '', 'line_source': 'ArI', 'line_notes': 'Blended in FLOYDS'},
                {'wavelength': 8424.6475, 'line_strength': 0.4551, 'line_source': 'ArI', 'line_notes': 'Blended in FLOYDS'},
                {'wavelength': 9194.6385, 'line_strength': 0.0023, 'line_source': 'ArI', 'line_notes': 'Too weak in FLOYDS'},
                ...
                {'wavelength': 10052.1, 'line_strength': '', 'line_source': 'ArI', 'line_notes': 'Weak'},
                {'wavelength': 10332.76, 'line_strength': '', 'line_source': 'ArI', 'line_notes': 'Weak'},
                {'wavelength': 10506.47, 'line_strength': '', 'line_source': 'ArI', 'line_notes': ''},
                {'wavelength': 10673.55, 'line_strength': '', 'line_source': 'ArI', 'line_notes': 'Too weak to get a reliable centroid'},
                {'wavelength': 10950.74, 'line_strength': '', 'line_source': 'ArI', 'line_notes': 'No flux in FLOYDS'},
